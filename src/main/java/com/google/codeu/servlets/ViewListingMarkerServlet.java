 ...
 */
@WebServlet("/viewListingMarkers")
public class ViewListingMarkerServlet extends HttpServlet {
  ...
  private List<Marker> getMarkers(String postID) {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    List<Marker> markers = getMarkers(id);
      Gson gson = new Gson();
