 ...
 */
@WebServlet("/userPageMarkers")
public class userPageMarkerServlet extends HttpServlet {
  ...
  private List<Marker> getMarkers(String user) {

    List<Marker> markers = new ArrayList<>();
    List<Listing>allListings=datastore.getListings(user, "user");
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    List<Marker> markers = getMarkers(user);
    Gson gson = new Gson();
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)throws IOException {
    ...
    if (userService.isUserLoggedIn()) {
      ...
      String images = "";
      String text = "";
      Listing listing = new Listing(user,"marker_in_map", "", lat, lng, content, 0.00, images);
